#ifndef B5505144_5895_4129_8A98_BEB22830F80E
#define B5505144_5895_4129_8A98_BEB22830F80E
#pragma once
#include <string>
...
private:
    ...
    Uint32 mouseButtonUint32FromString(const std::string& button_name);                       ///< @brief 将字符串按钮名转换为 SDL_Button
};

} // namespace engine::input 

#endif /* B5505144_5895_4129_8A98_BEB22830F80E */
