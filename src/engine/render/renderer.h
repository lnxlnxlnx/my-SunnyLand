#ifndef B58C9012_82B7_4D8A_9BA3_ABCA54106BF3
#define B58C9012_82B7_4D8A_9BA3_ABCA54106BF3
#pragma once
#include "sprite.h"
#include <string>
...
private:
    ...
    //NOTE: Renderer 不拥有 SDL_Renderer 和 ResourceManager 的生命周期，因此使用裸指针并在构造函数中验证它们的有效性。就是说 Renderer 不负责创建或销毁这些对象，而是依赖于外部代码来管理它们的生命周期。
...
#endif /* B58C9012_82B7_4D8A_9BA3_ABCA54106BF3 */
