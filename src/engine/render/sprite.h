 ...
 * @Description: 
 */
#ifndef C4A246A5_FCFF_4C7E_8754_DBE46A70DB4C
#define C4A246A5_FCFF_4C7E_8754_DBE46A70DB4C
// sprite.h
#pragma once
...
/**
 * @brief 表示要绘制的视觉精灵的数据。其实质上是一个数据容器，包含了渲染所需的基本信息。
 *
...
#endif /* C4A246A5_FCFF_4C7E_8754_DBE46A70DB4C */
