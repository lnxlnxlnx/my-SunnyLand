/*** 
 * @Date: 2026-05-07 22:29:32
 * @LastEditors: lnx a16725798566@163.com
 * @LastEditTime: 2026-05-08 15:04:23
 * @FilePath: /SunnyLand/src/engine/core/timer.cpp
 * @Description: 
 */
#include "timer.h"
...
namespace engine::core
{
    ...
    void Time::update()
    {
        ...
        auto current_delta_time = static_cast<double>(frame_start_time_ - last_time_) * time_scale_ / 1'000'000'000.0f;
